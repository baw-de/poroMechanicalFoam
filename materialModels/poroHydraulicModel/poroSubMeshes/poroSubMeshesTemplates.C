...
template<class Type>
void Foam::poroSubMeshes::mapSubMeshVolFields
(
...
template<class Type>
void Foam::poroSubMeshes::mapSubMeshSurfaceFields
(
...
template<class Type>
void Foam::poroSubMeshes::mapSubMeshPointFields
(
...
Foam::poroSubMeshes::lookupBaseMeshVolField
(
...
Foam::poroSubMeshes::lookupBaseMeshSurfaceField
(
    const word& fieldName,
    const fvMesh& subMesh
) const
